...
const jokes = [`Why did an old man fall in a well?
...
Because he’s always spotte,d!`,


  `W,hat do you get when you cross a snail with a porcupine?
A slowpoke!`,
...
Neither, it’s better to write with a pe,ncil!`,
...
Because he's only got l,ittle legs!`,
...
Pennsylvania!`,
  ...
  `Why cant you tell a joke to an egg?
It might crack up!`,

  `Why are fish so smart?
Because they live in sc,hools!`,
...
let j = document.getElementById("joke").innerHTML = random;

let ranindex = jokes.indexOf(random);

document.getElementById("d").innerHTML = ranindex;
